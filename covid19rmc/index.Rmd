...
RMC = tibble(city = c("Americana", "Artur Nogueira", "Campinas",
                      ...
                      "Valinhos", "Vinhedo", "Piracicaba", "Limeira","RMC"),
...
spdata = brasilio() %>%
  ...
  rmc = spdata %>% group_by(date) %>% 
    summarise(city='RMC', confirmed=sum(confirmed, na.rm=TRUE),
              ...
              estimated_population_2019=3224443+397322+300911,
...
> Neste dashboard, a escolha de RMC incluirá dados de Piracicaba e Limeira àqueles da definição-padrão da RMC.
